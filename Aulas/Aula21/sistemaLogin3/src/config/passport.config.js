...
const initializePassport = () => {
    passport.use('github', new GitHubStrategy({
        clientID: 'Iv1.8fa3615c1094dc76', // ID do cliente fornecido pelo GitHub OAuth
        clientSecret: '3f6829ae3f215547a17365d563e370aa91b23f1b', // Chave secreta do cliente fornecida pelo GitHub OAuth
