...
// Quando uma solicitação POST é feita para a raiz do roteador, a função postComercio do controlador de comércio é chamada
router.post('/', comercioController.postComercio);
...
// Quando uma solicitação PUT é feita para '/:id', a função putComercio do controlador de comércio é chamada
router.put('/:id', comercioController.putComercio);
