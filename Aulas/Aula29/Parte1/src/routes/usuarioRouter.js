...
// Quando uma solicitação POST é feita para a raiz do roteador, a função postUsuario do controlador de usuários é chamada
...
// Quando uma solicitação PUT é feita para '/:id', a função putUsuario do controlador de usuários é chamada
