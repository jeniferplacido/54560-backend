...
const soma = (num1, num2) => {
   if(!num1 || !num2) return 0;
   if(typeof num1 !== 'number' || typeof num2 !== 'number') return null;
   // A linha abaixo está comentada, então a função não realiza a soma e retorna 'undefined'
...
// Este teste irá falhar, pois a função 'soma' está retornando 'undefined' ao invés de realizar a soma
